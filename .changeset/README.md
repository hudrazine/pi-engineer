...
Add a changeset to a pull request when it changes the published package in a way users should see in a release. This includes new behavior, bug fixes, compatibility changes, prompt changes, and dependency updates that affect users.
