...
test("reports active status, custom prompt precedence, and command usage", async () => {
  ...
  expect(notifications).toEqual([
    { message: "pi-engineer active (package 0.0.0, Portable Core 0.3).", type: "info" },
    {
      message:
        "pi-engineer inactive: an explicit custom system prompt is active (package 0.0.0, Portable Core 0.3).",
      type: "info",
    },
